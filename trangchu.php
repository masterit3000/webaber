			...
			<div class="row">
				<div class="col-md-3 col-sm-6">
					<div class="item matchHeight vip">
						<div class="image">
							<img src="public/images/_tariff-1.png" class="full-width" alt="Tariff">
						</div>
						<h4 class="red">Xe 4 chỗ</h4>
						<p>&nbsp;</p>
						<div class="price">
							<small style="font-size:50%">từ</small> 6.500
							<span>/km</span>
						</div>
					</div>
				</div>
				<div class="col-md-3 col-sm-6">
					<div class="item matchHeight">
						<div class="image">
							<img src="public/images/_tariff-3.png" class="full-width" alt="Tariff">
						</div>
						<h4>Xe 7 chỗ</h4>
						<p>&nbsp;</p>
						<div class="price">
							<small style="font-size:50%">từ</small> 8.500
							<span>/km</span>
						</div>
					</div>
				</div>
				<div class="col-md-3 col-sm-6">
					<div class="item matchHeight">
						<div class="image">
							<img src="public/images/_tariff-2.png" class="full-width" alt="Tariff">
						</div>
						<h4>Xe riêng</h4>
						<p>&nbsp;</p>
						<div class="price">
							<small style="font-size:50%">từ</small> 8.000
							<span>/km</span>
						</div>
					</div>
				</div>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-4 col-md-pull-4 col-sm-12">
					<div class="mob">
						<a target="_blank" href="https://play.google.com/store/apps/details?id=aber.com.user_order">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6">
					...
					<a target="_blank" href="https://play.google.com/store/apps/details?id=taxila.com.driver_order" style="width: 49%;float: left;margin-right: 5px;">
						<img src="public/images/_app-google.png" alt="Android" style="height: 50px;max-width: 100%">
					</a>
					<a target="_blank" href="https://itunes.apple.com/us/app/taxila-driver/id1367803992?ls=1&amp;mt=8" style="width: 49%;float: left">

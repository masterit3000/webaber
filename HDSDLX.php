		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-4 col-sm-6 col-ms-6 matchHeight">
					<div class="image">
						<img src="public/images/Picture1.png" alt="Service">
					</div>
					<h5>No1. Chuẩn bị hồ sơ tham gia Aber</h5>
				</div>
				<div class="col-md-4 col-sm-6 col-ms-6 matchHeight">
					<div class="image">
						<img src="public/images/Picture2.png" alt="Service">
					</div>
					<h5>No2. Phỏng vấn/tuyển chọn</h5>
				</div>
				<div class="col-md-4 col-sm-6 col-ms-6 matchHeight">
					<div class="image">
						<img src="public/images/Picture4-1.png" alt="Service">
					</div>
					<h5>No.3 Cập nhật hồ sơ đối tác
Đào tạo – chụp hình </h5>
				</div>
			</div>
		</div>
    </section>
...
Kích hoạt tài khoản</h5>
				...
				<div class="col-md-4 col-sm-6 col-ms-6 matchHeight">
					<div class="image">
						<img src="public/images/Picture6.png" alt="Service">
					</div>
                    <h5>No5. Đồng phục</h5>
                    <p>(Không bắt buộc)</p>
				</div>
				<div class="col-md-4 col-sm-6 col-ms-6 matchHeight">
					<div class="image">
						<img src="public/images/Picture7-1.png" alt="Service">
					</div>
                    <h5>No6. Giới thiệu về tổ đội/nhóm </h5>
                    <p>Theo dõi và hỗ trợ đối tác trong công việc</p>
				</div>
			</div>
		</div>
    </section>
        ...
        <div class="row">
            <div class="col-md-6 col-sm-6 col-ms-6 matchHeight">
                    ...
                    <p class="text-justify">1/ CMND/CCCD/Hộ chiếu: Còn hạn sử dụng.</br>
                                            2/ Thẻ sinh viên: Còn giá trị sử dụng.</br>
                                            3/ Giấy đăng ký xe (cà vẹt xe) – không cần chính chủ.</br>
                                            4/ Giấy phép lái xe (hạng A1, A2): Còn hạn sử dụng.</br>
                                            5/ Bảo hiểm xe: Còn hạn sử dụng, đúng tên với cà vẹt xe máy tham gia Aber.</br>
                    </p>
            </div>
            <div class="col-md-6 col-sm-6 col-ms-6 matchHeight">
					<div class="image">
                    ...
                    <p class="text-justify">1/ CMND/CCCD/Hộ chiếu: Còn hạn  sử dụng.</br>
                                            ...
                                            6/ Bảo hiểm xe: Còn hạn sử dụng, đúng tên với cà vẹt xe máy tham gia Aber.</br>
                    </p>
			</div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-6 col-sm-6 col-ms-6 matchHeight">
                    ...
                    <p class="text-justify">1/ CMND/CCCD/Hộ chiếu: Còn hạn  sử dụng.</br>
                                            2/Hộ khẩu thường trú/KT3.</br>
                                            3/ Sơ yếu lý lịch địa phương/Xác nhận hạnh kiểm/Lý lịch tư pháp: Có chứng nhận của UBND cấp có thẩm quyền nơi cư trú (thời hạn không quá 6 tháng. Nếu thiếu bổ sung trong vòng 15 ngày).</br>
                                            4/ Giấy khám sức khỏe có xét nghiệm ma túy.</br>
                                            5/ Giấy đăng ký xe (cà vẹt xe) – Giấy chứng nhận đăng kiểm kinh doanh.</br>
                                            6/ Giấy phép lái xe (hạng B1 trở lên): Còn hạn sử dụng.</br>
                                            7/ Bảo hiểm xe bắt buộc trách nhiệm dân sự kinh doanh: Còn hạn sử dụng.</br>
                                            8/ Giấy xác nhận đăng ký tham gia HTX, nếu có.</br>
                                            9/ Phù hiệu xe chạy hợp đồng.</br>
                    </p>
            </div>
            <div class="col-md-6 col-sm-6 col-ms-6 matchHeight">
					<div class="image">
                    ...
                    <p class="text-justify">1/ CMND/CCCD/Hộ chiếu chủ doanh nghiệp: Còn hạn  sử dụng.</br>
                                            ...
                                            7/ Bảo hiểm xe bắt buộc trách nhiệm dân sự kinh doanh: Còn hạn sử dụng.</br>
                                            8/ Phù hiệu xe chạy hợp đồng của công ty được Sở GTVT cấp: Còn hiệu lực.</br>
                    </p>
			</div>
        </div>
    </div>
